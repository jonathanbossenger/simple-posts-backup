...
Installing "Simple Posts Backup" can be done either by searching for "Simple Posts Backup" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
